        ...
        <ul class="list-unstyled comments">
            <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
                ...
                <ul class="nav menu">
                    ...
                    <li class="{{ request()->is('rfq*') ? 'active' : '' }}, parent"><a href="#sub-item-1" data-toggle="collapse" aria-expanded="false"><em class="fa fa-cart-plus ">&nbsp;</em> Order Bahan
                        ...
                        <ul class="children collapse" id="sub-item-1">
                            ...
                            <li>
                                <a href="{{ route('po.index') }}"><span class="fa fa-arrow-right">&nbsp;</span>Purchase Order</a>
                            </li>
                        </ul>
                    </li>

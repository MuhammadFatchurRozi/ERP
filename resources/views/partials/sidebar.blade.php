            ...
            <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar wow fadeInLeft">
                ...
                <ul class="nav menu">
                    ...
                    <li class="{{ request()->is('product*') ? 'active' : '' }}"><a
                            href="{{ route('product.index') }}"><em class="fa fa-user-circle-o ">&nbsp;</em>Data
                            Product</a></li>
                    ...
                    <li class="{{ request()->is('rfq*' && 'po*') ? 'active' : '' }}, parent"><a href="#sub-item-1"
                            data-toggle="collapse" aria-expanded="false"><em class="fa fa-cart-plus ">&nbsp;</em> Order
                            Bahan
                        ...
                        <ul class="children collapse" id="sub-item-1">
                            <li>
                                <a class="{{ request()->is('rfq*') ? 'active' : '' }}"
                                    href="{{ route('rfq.index') }}"><span
                                        class="fa fa-arrow-right">&nbsp;</span>RFQ</a>
                            </li>
                            <li>
                                <a class="{{ request()->is('po*') ? 'active' : '' }}"
                                    href="{{ route('po.index') }}"><span
                                        class="fa fa-arrow-right">&nbsp;</span>Purchase Order</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="{{ request()->is('pesanan*') ? 'active' : '' }}"><a
                            href="{{ route('pesanan.index') }}"><em class="fa fa-shopping-cart">&nbsp;</em> Detail
                            Pesanan</a></li>

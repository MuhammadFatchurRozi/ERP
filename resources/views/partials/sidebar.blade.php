...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    ...
    <ul class="nav menu">
        ...
        <li class="{{ request()->is('kasir*') ? 'active' : '' }}"><a href="{{ route('kasir.index') }}"><em class="fa fa-barcode  ">&nbsp;</em> Kasir</a></li>
        <li class="{{ request()->is('product*') ? 'active' : '' }}"><a href="{{ route('product.index') }}"><em class="fa fa-user-circle-o ">&nbsp;</em> Product</a></li>

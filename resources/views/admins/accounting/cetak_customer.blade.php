...
<head>
    ...
    <title>{{ $title_date->to_accounting }} </title>
                                ...
                                <div class="row gutters">
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                        <a href="index.html" class="invoice-logo">
                                            Report {{ $title_date->to_accounting }}
                                        </a>
                                    </div>
                                ...
                                <div class="row gutters">
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="table-responsive">
                                            <table class="table custom-table m-0 table-bordered">
                                                ...
                                                <tbody>
                                                    @forelse ($accounting_customer as $ac)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                {!! DNS1D::getBarcodeHTML($ac->kode_accounting_customer, 'C39', 0.6, 35,'white') !!}
                                                            </td>
                                                            <td>{{ $ac->name }}</td>
                                                            <td>{{ $ac->address }}</td>
                                                            <td>{{ $ac->phone }}</td>
                                                            ...
                                                            <td>{{ $ac->quantity }}</td>
                                                            <td><span>{{ $ac->tgl_pemesanan }}</span>
                                                            </td>
                                                            <td><span>{{ $ac->tgl_pembayaran }}</span>
                                                            </td>
                                                            <td><span
                                                                    class="badge bg-success">{{ $ac->status }}</span>
                                                            </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5 class="text-success">
                                                                <strong>Rp.@idr($sum_totals)</strong>
                                                            </h5>
                                                        </td>
                                                    </tr>
                                                </tbody>

            ...
            <form method="POST" action="{{ route('costumer.update', $cotumers->id) }}">
                ...
                <div class="form-row" style="text-align: center">
                    <div class="col-md-3 mb-3 input-group-sm">
                        ...
                        <input type="text" id="#" name="nama" placeholder="" value="{{ old('nama', $cotumers->nama) }}" class="form-control input-lg" required>
                    </div>
                    <div class="col-md-3 mb-3 input-group-sm">
                        <label for="Alamat">Alamat</label>
                        <input type="text" class="form-control" id="alamat" placeholder="" name="alamat" value="{{ old('alamat', $costumers->alamat) }}" required></textarea>
                    </div>
                    <div class="col-md-3 mb-3 input-group-sm">
                        <label for="harga">No.Hp</label>
                        <input type="number" id="#" name="NoHp" placeholder="" value="{{ old('NoHp', $costumers->NoHp) }}" class="form-control input-lg" required>
                    </div>
                </div>
        </div>
        <div class="form-row">

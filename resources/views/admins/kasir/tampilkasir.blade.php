        ...
        <form class="needs-validation" method="post" action="{{ route('bom.store') }} ">
            ...
            <div class="form-row" style="text-align: center">
                <div class="col-md-3 mb-3 input-group-sm">
                    ...
                    <select name="kode" id="kode" class="form-control input-lg dynamic" data-dependent="nama" data-dynamic="ukuran"> required>

                    </select>
                </div>
                <div class="col-md-3 mb-3 input-group-sm">
                    <label for="nama">Nama Produk</label>
                    <select name="nama" id="nama" class="form-control input-lg" data-dependent="ukuran">
                ...
                <div class="col-md-3 mb-3 input-group-sm">
                    ...
                    <select name="ukuran" id="ukuran" class="form-control input-lg">
                ...
                <div class="col-md-3 mb-3 input-group-sm">
                    <label for="jumlah">Jumlah(lusin)</label>

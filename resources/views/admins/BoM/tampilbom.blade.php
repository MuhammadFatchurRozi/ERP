                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <form class="form-inline">
                            ...
                            <div class="form-group">
                                <a type="button" class="btn btn-danger" href="{{ route('bom.create') }}"><i class="fa fa-plus"></i> Tambah</a>
                            </div>
                        </form>
                    </div>
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            <tbody class="text-center" style="vertical-align:middle;">
                                ...
                                <tr>
                                    ...
                                    <td>{{ $bom->kain }} </td>
                                    <td>{{ $bom->benang }} </td>
                                    <td>Rp.@idr($bom->harga) </td>
                                    <td>{{ $bom->quantity }} </td>
                                    <td>{{ $bom->estimasi }} </td>
                                    <td>
                                        <div class="action">
                                            <a href="{{ route('bom.cetak', $bom->id) }}" class="action btn btn-sm btn-info"><i class="fa fa-file-text"></i></a>
                                            <a href="{{ route('bom.edit', $bom->id) }}" class="action btn btn-sm btn-warning"><i class="fa fa-pencil"></i></a>

                ...
                <form class="needs-validation" method="post" action="{{ route('bom.store') }} ">
                    ...
                    <div class="form-row" style="text-align: center">
                        <div class="col-md-3 mb-3 input-group-sm">
                            ...
                            <select name="kode" id="kode" class="form-control input-lg dynamic"
                                data-dependent="nama" data-dynamic="ukuran">
                                required>
                        ...
                        <div class="col-md-3 mb-3 input-group-sm">
                            ...
                            <input type="text" class="form-control" id="kain" placeholder="" name="kain"
                                required>
                        </div>
                        <div class="col-md-3 mb-3 input-group-sm">
                            <label for="harga">benang</label>
                            <input type="text" class="form-control" id="harga" placeholder="" name="benang"
                                required>
                        </div>
                        <div class="col-md-3 mb-3 input-group-sm">
                            <label for="quantity">Quantity</label>
                            <input value="1" placeholder="1" type="text" class="form-control" id="quantity"
                                placeholder="" name="quantity" readonly>
                        </div>
                        <div class="col-md-3 mb-3 input-group-sm">
                            <label for="estimasi">Estimasi Waktu</label>
                            <input type="text" class="form-control" id="estimasi" placeholder="" name="estimasi"
                                required>
                        </div>
                    </div>
            </div>

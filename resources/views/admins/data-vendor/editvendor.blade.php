                    ...
                    <div class="form-row" style="text-align: center">
                        <div class="col-md-3 mb-3 input-group-sm">
                            ...
                            <select name="nama_bahan_baku" id="" class="form-control input-lg" required>
                                <option value="{{ old('nama_bahan_baku', $vendors->nama_bahan_baku) }}" readonly="readonly"
                                    selected>{{ old('nama_bahan_baku', $vendors->nama_bahan_baku) }}</option>
                        ...
                        <div class="col-md-3 mb-3 input-group-sm">
                            ...
                            <input type="number" id="#" name="harga" placeholder=""
                                value="{{ old('harga', $vendors->harga) }}" class="form-control input-lg" required>
                        </div>
                        <br>
                        <br>
                        <br>

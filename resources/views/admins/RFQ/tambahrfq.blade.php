            ...
            <form class="needs-validation" method="post" action="{{ route('rfq.store') }} ">
                ...
                <div class="form-row" style="text-align: center">
                    <div class="col-md-3 mb-3 input-group-sm">
                        ...
                        <select name="id" id="id" class="form-control input-lg dynamic" data-dependent="nama_produk" data-dynamic="harga" data-dynamic1="nama_vendor" data-dynamic2="alamat" data-dynamic3="no_telp">
                            <option disabled selected>---- Pilih Produk ----</option>
                            @foreach ($vendors as $v)
                            <option value="{{ $v->id }}">{{ $v->nama_produk }} || {{ $v->harga }} ||
                                {{ $v->nama_vendor }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-3 mb-3 input-group-sm">
                        ...
                        <select type="text" class="form-control dd" id="nama_produk" name="nama_produk" readonly="readonly">
                        </select>
                    </div>
                    <div class="col-md-3 mb-3 input-group-sm">
                    ...
                    <div class="col-md-3 mb-3 input-group-sm">
                        ...
                        <input type="text" class="form-control" id="quantity" placeholder="" name="quantity" onchange="total_harga();" required>
                    </div>
                    <div class="col-md-4 mb-4 input-group-sm">
                        <label for="total">Total</label>
                        <input type="text" class="form-control" onchange="total_harga();" id="total" placeholder="" name="total" required readonly>
                    </div>
                    <br>
                    <br>
                    <br>
                    ...
                    <div class="col-md-4 mb-4 input-group-sm">
                        ...
                        <select type="text" class="form-control dd" id="nama_vendor" placeholder="" name="nama_vendor" readonly="readonly"></select>
                    </div>
                    <div class="col-md-4 mb-4 input-group-sm">
                        <label for="Alamat">Alamat</label>
                        <select type="text" class="form-control dd" id="alamat" placeholder="" name="alamat" readonly="readonly"></select>
                    </div>
                    <div class="col-md-4 mb-4 input-group-sm">
                        <label for="no_telp">No Telpon</label>
                        <select type="text" class="form-control dd" id="no_telp" placeholder="" name="no_telp" readonly="readonly"></select>
                    </div>
                </div>

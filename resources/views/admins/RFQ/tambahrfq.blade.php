                    ...
                    <div class="form-row" style="text-align: center">
                        <div class="col-md-3 mb-3 input-group-sm">
                            ...
                            <select name="id" id="id" class="form-control input-lg dynamic"
                                data-dependent="nama_produk" data-dynamic="harga" data-dynamic1="nama_vendor"
                        ...
                        <div class="col-md-3 mb-3 input-group-sm">
                            ...
                            <select type="text" class="form-control dd" id="nama_produk" name="nama_produk"
                                readonly="readonly">
                            </select>
                        </div>
                        <div class="col-md-3 mb-3 input-group-sm">
                            ...
                            <select type="text" class="form-control dd" id="harga" placeholder="" name="harga"
                                onchange="total_harga();" readonly="readonly">
                            </select>
                        </div>
                        <div class="col-md-3 mb-3 input-group-sm">

                ...
                <form class="needs-validation" method="post" action="{{ route('quotation.store') }} ">
                    ...
                    <div class="form-row" style="text-align: center">
                        <div class="col-md-3 mb-3 input-group-sm">
                            ...
                            <select name="costumer" id="costumer" class="form-control input-lg dynamic"
                        ...
                        <div class="col-md-3 mb-3 input-group-sm">
                            ...
                            <input type="text" class="form-control" id="produk" placeholder="" name="produk"
                                required>
                        </div>
                        <div class="col-md-3 mb-3 input-group-sm">
                        ...
                        <div class="col-md-3 mb-3 input-group-sm">
                            ...
                            <input type="text" class="form-control" id="" placeholder="" name="total" required
                                readonly>
                        </div>
                        <div class="col-md-3 mb-3 input-group-sm">
                            <br>

        ...
        <form class="needs-validation" method="post" action="{{ route('product.store') }} " novalidate>
            ...
            <div class="form-row" style="text-align: center">
                <div class="col-md-3 mb-3 input-group-sm">
                    ...
                    <input name="kode" id="kode" class="form-control input-lg dynamic" data-dependent="nama" data-dynamic="nama">
                </div>
                <div class="col-md-3 mb-3 input-group-sm">
                ...
                <div class="col-md-3 mb-3 input-group-sm">
                    ...
                    <input name="harga" id="harga" class="form-control input-lg dynamic" data-dependent="harga" data-dynamic="harga">
                </div>
                <div class="col-md-3 mb-3 input-group-sm">
